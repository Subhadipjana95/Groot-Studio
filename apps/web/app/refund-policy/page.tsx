import { refundPolicy } from "@/data/RefundPolicy.data"
            ...
            <main className='max-w-6xl mx-auto relative pt-20 py-12 md:pt-24 sm:border-x px-6 md:px-12'>
                ...
                <div className="mb-12 space-y-4 max-w-3xl">
                    ...
                    <h1 className="font-normal font-sans text-4xl tracking-tight sm:text-5xl text-foreground">
                        <span className="text-brand1 [text-shadow:0_0_12px_var(--brand1)] font-[gambarino] font-medium">Refund</span> Policy
                    </h1>
                    <p className="max-w-2xl text-lg text-muted-foreground">
                        Our policy regarding billing, subscription renewals, cancellations, and refund eligibility for Groot Studio sponsorships.
                    </p>
                </div>

                {/* Sections */}
                <div className="space-y-4 md:space-y-6">
                    {refundPolicy.map(({ icon: Icon, title, content }) => (
                        <div
                            key={title}
