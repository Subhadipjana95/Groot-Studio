  ...
  ({ href, label, className, innerClassName, asChild = false, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <span className={cn("w-full inline-flex items-center justify-center gap-1 rounded-md border bg-radial from-background to-accent/60 text-muted-foreground transition-colors ring-1 ring-accent text-shadow-md px-3 py-1.5 text-xs sm:text-sm", innerClassName)}>
          {label}
        </span>
      </Comp>
    )
